...
python train_net.py COCO-InstanceSegmentation/mask_rcnn_R_101_C4_3x.yaml --output output/r101_c4 --train_only # 3
python train_net.py COCO-InstanceSegmentation/mask_rcnn_R_101_FPN_3x.yaml --output output/r101_fpn --train_only # 4
python train_net.py COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml --output output/r50_fpn --train_only # 5
python train_net.py Cityscapes/mask_rcnn_R_50_FPN_3x.yaml --output output/r50_fpn_cityscapes --train_only # 6
