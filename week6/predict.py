...
def filter_preds(preds, mapping_pretrain_to_dataset, mots=True):
...
if __name__ == '__main__':
    from kitti_mots_dataset import kitti_correspondences, mots_correspondences
    ims_path_kitti = "datasets/KITTI-MOTS/training/image_02"
    annots_path_kitti = "datasets/KITTI-MOTS/instances_txt"
    ims_path = "datasets/MOTSChallenge/train/images"
    annots_path = "datasets/MOTSChallenge/train/instances_txt"
    ...
    inference("COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml", kitti_to_mots_dict)
