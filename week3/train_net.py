...
if __name__ == '__main__':
    ...
    cfg.SOLVER.IMS_PER_BATCH = b_size
    ...
    # # cfg.MODEL.ROI_HEADS.NUM_CLASSES = 2
    # cfg.SOLVER.MAX_ITER = 200 # epoch * 12
    ...
    #
    dataset_dicts = get_kiti_mots_dicts("/home/devsodin/datasets/KITTI-MOTS/training/image_02",  "/home/devsodin/datasets/KITTI-MOTS/instances_txt", is_train=False, image_extension='png')
    #
    # # plot_losses(cfg)
